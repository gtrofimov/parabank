...
for variable in DTP_PROJECT DTP_UT_COVERAGE_IMAGES DTP_SOATEST_COVERAGE_IMAGES SOATEST_URL SOATEST_SERVER SOATEST_CONFIG \
    REPORT_ROOT REPORT_JTEST_ROOT REPORT_SOATEST_ROOT REPORT_APP_COVERAGE_ROOT \
    SOATEST_REPORT_ROOT JTEST_APP_COVERAGE_REPORT_ROOT PARABANK_SERVLET_PORT JTEST_AGENT_REST_PORT \
    PARABANK_DOCKER_CONTAINER; do

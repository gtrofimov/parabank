...
- Request contract: path param `accountId` (int), query param `threshold` (BigDecimal, required)
...
- Required environment or credentials: DTP_URL, DTP_USER, DTP_PASSWORD (for publishing reports)
...
- Functional or API report: SOAtest scenario report with coverage (soatest-orchestration)
- Coverage report: jtest-cov-analysis
- DTP or CI build reference: Parabank-Jenkins-local-20260910-PGT-23

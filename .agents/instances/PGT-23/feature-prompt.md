...
- Request contract: path param accountId (int), query param threshold (amount, BigDecimal)
...
- DTP or CI build reference: Parabank-Jenkins-local-20260909-PGT-23

## Definition of Done

Complete only when all acceptance criteria are met, all required validation evidence exists, and no blocking quality gate remains unresolved. This issue is a local pipeline dry-run to validate the CICD workflow before PGT-22.
